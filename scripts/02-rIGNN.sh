...
python -u -m main --gpu_id 1 --seed 42 --dataset arxiv --source ogb --model ignn --n_epochs 3000 --agg_type gcn --IN IN-nSN --h_feats 512 --lr 0.0005 --l2_coef 0.000001 --n_hops 1 --n_layers 6 --early_stop 300 --RN residual --norm_type ln --act_type prelu --preln False --pre_dropout 0.0 --hid_dropout 0.8 --clf_dropout 0.8 --public True --repeat 3

python -u -m main --gpu_id 1 --seed 42 --dataset products --source ogb --model ignn --n_epochs 3000 --agg_type gcn --IN IN-nSN --h_feats 200 --lr 0.0005 --l2_coef 0.00001 --n_hops 1 --n_layers 5 --early_stop 200 --RN residual --norm_type ln --act_type relu --fast False --pre_dropout 0.2 --hid_dropout 0.8 --clf_dropout 0.9 --eval_start 280 -i 3
