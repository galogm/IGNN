...
python -u -m main --gpu_id 2 --seed 42 --dataset actor --source pyg --model ignn --n_epochs 3000 --agg_type gcn --IN IN-nSN --h_feats 128 --lr 0.005 --l2_coef 5e-05 --n_hops 1 --n_layers 5 --early_stop 150 --RN attentive --norm_type none --act_type none --att_act_type relu --preln False --pre_dropout 0.5 --hid_dropout 0.6 --clf_dropout 0.0

python -u -m main --gpu_id 2 --seed 42 --dataset chameleon --source critical --model ignn --n_epochs 3000 --agg_type gcn --IN IN-nSN --h_feats 128 --lr 0.005 --l2_coef 0.0005 --n_hops 1 --n_layers 5 --early_stop 200 --RN attentive --norm_type ln --act_type relu --att_act_type prelu --preln False --pre_dropout 0.8 --hid_dropout 0.7 --clf_dropout 0.4
...
python -u -m main --gpu_id 2 --seed 42 --dataset photo --source pyg --model ignn --n_epochs 3000 --agg_type gcn --IN IN-nSN --h_feats 512 --lr 0.001 --l2_coef 1e-05 --n_hops 1 --n_layers 3 --early_stop 200 --RN attentive --norm_type none --act_type prelu --att_act_type gelu --pre_dropout 0.5 --hid_dropout 0.8 --clf_dropout 0.9
...
python -u -m main --gpu_id 2 --seed 42 --dataset wikics --source pyg --model ignn --n_epochs 3000 --agg_type gcn --IN IN-nSN --h_feats 512 --lr 0.001 --l2_coef 0.0005 --n_hops 10 --n_layers 1 --early_stop 200 --RN attentive --norm_type ln --act_type prelu --att_act_type none --pre_dropout 0.3 --hid_dropout 0.9 --clf_dropout 0.7

python -u -m main --gpu_id 2 --seed 42 --dataset arxiv --source ogb --model ignn --n_epochs 3000 --agg_type gcn --IN IN-nSN --h_feats 512 --lr 0.0005 --l2_coef 1e-5 --n_hops 1 --n_layers 6 --early_stop 200 --RN attentive --norm_type ln --act_type relu --att_act_type sigmoid --pre_dropout 0.0 --hid_dropout 0.8 --clf_dropout 0.8 --public True --repeat 3
