...
id=0;model="r-IGNN";d=products;gpu=$id;log_path=logs/$model/$d;mkdir -p $log_path;nohup python -u -m scripts.02rignn_search --gpu=$gpu --dataset=$d --n_trials=64 --n_jobs=2 --repeat=1 > $log_path/$id.log 2>&1 & echo $!
```
"""
